...
function evaluarExamen() {
    ...
    if(notaFinal >= 18) {
        ...
        document.getElementById("mensaje-final").style.color = "#2ecc71"; // Verde para éxito
    } else {
        document.getElementById("mensaje-final").textContent = "Sigue practicando para alcanzar el nivel 2";
        document.getElementById("mensaje-final").style.color = "#e74c3c"; // Rojo para indicar falta
    }
}
